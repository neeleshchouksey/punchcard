...
class CheckFaceRequest extends ApiRequest
{
    ...
    protected function punchSetup($data)
    {
        ...
        $project        = Project::where('uniq_id', $data['face_provided_project_uniq_id'])->first();
        $user           = User::where('uniq_id', $data['face_provided_user_uniq_id'])->first();
    ...
    public function rules()
    {
        return [
            ...
            'face_provided_user_uniq_id' => 'required|uuid',
            'face_provided_project_uniq_id' => 'required|uuid',
