...
<div v-if="user">
    ...
    <div class='row' v-if="adminEditingUser && false">
        <h4 class='collapsible-header'>
            <i class='fa fa-chevron-right'></i>
    ...
    <div class='row' v-if="false">
        ...
        <div :class="[showExpanded ? editingClass : notEditingClass]">
          ...
          <form-dropdown name="user.jdoc.demographics.ethnicity" :edit_mode="edit_mode" v-model="user.jdoc.demographics.ethnicity" :options="ethnicityOptions" style="text-transform: capitalize;">
            ...
            <form-input  v-on:input="emitChange">
    ...
    export default {
        ...
        methods: {
          ...
          calculateEstimatedPremimum : function(){
            if(this.user.jdoc.payroll_data.pay_rate && this.user.jdoc.payroll_data.expModifier && this.user.jdoc.payroll_data.rate){
              try {
                var estimatedPremium = 0;
                estimatedPremium = 160* Number(this.user.jdoc.payroll_data.pay_rate);
            ...
            handleImageUpload(imgInfo, imgData) {
              ...
              this.user.image = imgSplit[1];
                // let result = imageUpload.saveUserAvatar(imgInfo, imgData, this.user);
            },
        }
    }
</script>
