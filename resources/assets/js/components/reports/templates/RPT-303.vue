        ...
        computed: {
            ...
            computedRows: function ()
            {
                ...
                let exportableReportData = _.map(this.reportData.reportData.rows, (row) => {
                    let uniq_id = row[0];
                    row[3] = '<a target="_blank" href="/projectEmployeesOnsite/' + row[0] + '">View Employees</a>';
                    
                    // row[3] = '<a target="_blank" href="/report/212da9b3-27cb-4772-afe0-cd62aed45b32">View Employess</a>';
