    ...
    <div>
        ...
        <div class="row options-row" ref="reportOptions">
            <div v-if="atLeastOneDropdownOption" class="col-sm-5">
                ...
                <form-dropdown :edit_mode="true"
                    v-on:option-changed="addressSelectChanged"
                    v-model="addressQueryParam"
                    :options="addressOptions" v-if="addressOptions">
                    Address
                </form-dropdown>
                <form-dropdown :edit_mode="true"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            {
                return this.clientOptions || this.userOptions || this.projectOptions || this.addressOptions;
            },
            ...
            addressOptions: function ()
            {
                ...
                if (typeof this.reportOptionData.address === 'undefined') {
                    return;
                }

                if (! this.reportOptionData.address.length) {
                    return;
                }

                let chosenClient = this.chosenClient;

                let filtered = _.filter(this.reportOptionData.address, function(o) {
                    let client_uniq_id;
        ...
        methods: {
            ...
            addressSelectChanged: function (data) {
                this.allData.address = data;
                this.reportDataChanged();
            },
