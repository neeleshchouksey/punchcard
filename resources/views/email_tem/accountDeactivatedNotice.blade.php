...
">Hello {{ $clientAdminFirstName }}!</h3>
    ...
    font-size: 13px;
    line-height: normal;
">Your Punchcard account has been deactivated and {{ $companyName }}.punchcardllc.com is no longer available to any users as of {{ $deactivatedDate }}.
</p>

<p style="
    font-size: 13px;
    color: #333232;
">Please contact us if you would like to renew your subscription.</p>
